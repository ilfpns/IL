...
⇒ 트랜시버는 송신기와 수신기의 합성어이다 양방향 통신이 필요한 경우 필수이다 데이터 전송, 기기간 통신, 무선 제어의 용도로 사용됨

방향이 양방향이라고 모두 트랜시버는 아니다 물리적인 기기만 포함한다 (Tx, Rx)

- 1 : N 통신을 지원하는 동기식 통신 방식이다
- 다수의 통신을 원한다면 다수만큼의 선이 필요하다
- 동시 송수신이 가능하며 I2C보다 빠르다

![[Pasted image 20260110205028.png]]
...
![[Pasted image 20260110205042.png]]
...
![[Pasted image 20260110205052.png]]
...
![[Pasted image 20260110205107.png]]
